...
class Common
{
    ...
    public static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
    {
        ...
        if ($useCert == true) {
            ...
            curl_setopt($ch, CURLOPT_SSLCERTTYPE, 'PEM');#echo dirname ($_SERVER['DOCUMENT_ROOT']) . DIRECTORY_SEPARATOR . 'Site' . DIRECTORY_SEPARATOR . 'wh_wechat' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'cert' . DIRECTORY_SEPARATOR . 'apiclient_cert.pem';exit;
            curl_setopt($ch, CURLOPT_SSLCERT, dirname ($_SERVER['DOCUMENT_ROOT']) . DIRECTORY_SEPARATOR . 'Site' . DIRECTORY_SEPARATOR . 'wh_wechat' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'cert' . DIRECTORY_SEPARATOR . 'apiclient_cert.pem');
            curl_setopt($ch, CURLOPT_SSLKEYTYPE, 'PEM');
            curl_setopt($ch, CURLOPT_SSLKEY, dirname ($_SERVER['DOCUMENT_ROOT']) . DIRECTORY_SEPARATOR . 'Site' . DIRECTORY_SEPARATOR . 'wh_wechat' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'cert' . DIRECTORY_SEPARATOR . 'apiclient_key.pem');
        }
        //post提交方式
